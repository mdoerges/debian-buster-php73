...
RUN apt-get install --no-install-suggests -y ca-certificates php7.3-fpm php7.3-common php7.3-mysql php7.3-zip php7.3-gd \ 
    php7.3-mbstring php7.3-xml php-imagick imagemagick
